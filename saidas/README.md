...
- **Análises** de `/negocio-analisar-dados` — resumos executivos de CSV/XLSX/PDF
- **Emails** rascunhados por `/venda-email`
...
```
saidas/
├── analises/        relatórios de /negocio-analisar-dados
├── emails/          rascunhos de /venda-email
...
A divisão importa pra `/sistema-salvar` (commit) e pra clareza ao navegar a pasta.
