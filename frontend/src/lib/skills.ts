...
export const hubs: Hub[] = [
  {
    ...
    skills: [
      ...
      { id: "lb-meta-analise-reels", name: "Análise de Reels", description: "Performance dos Reels pagos e ranking de criativos.", icon: Film, route: "/reels" },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: "lb-sistema-abrir", name: "Abrir Projeto", description: "Abre projeto existente para edição.", icon: FolderOpen },
      { id: "lb-sistema-instalar", name: "Instalar", description: "Instala dependências do projeto.", icon: Download },
      { id: "lb-sistema-atualizar", name: "Atualizar", description: "Atualiza dependências e skills.", icon: RefreshCw },
      { id: "lb-sistema-salvar", name: "Salvar / Backup", description: "Salva estado do projeto e cria backup.", icon: Save },
