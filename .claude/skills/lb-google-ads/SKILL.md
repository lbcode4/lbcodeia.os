...
Filtrar pelos de **intenção comercial/transacional** (descartar informacionais — viram blog em `/lb-google-seo`).
...
**Pré-requisito:** GBP otimizado (rodar `/lb-google-meu-negocio` antes). Sem perfil completo, campanha rende mal.
