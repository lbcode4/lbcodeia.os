...
description: >
  ...
  "diagnóstico de marketing", "o que essa empresa tem de errado", ou /venda-diagnostico.
---

# /venda-diagnostico — Diagnóstico digital gratuito como isca de venda
...
Sempre oferecer:
> "Quer usar esse diagnóstico como base pra abordagem? (chamo `/venda-prospectar`)"
> "Quer montar proposta com esses gaps já mapeados? (chamo `/venda-proposta`)"
