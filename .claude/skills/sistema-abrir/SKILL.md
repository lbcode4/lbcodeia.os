...
# /sistema-abrir — Sessão de trabalho
...
> Quer rodar `/sistema-instalar` agora pra completar?"
...
Internamente, `/sistema-abrir` já sabe que:

- Cada skill de marketing lê `framework-trafego.md`
- Cada skill visual lê `design-guide.md`
- Cada execução é versionada automaticamente via `/sistema-salvar`
