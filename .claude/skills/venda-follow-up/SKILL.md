...
description: >
  ...
  Complementa /venda-prospectar que para na abordagem inicial.
  Use quando o usuário pedir "follow-up", "sequência de acompanhamento", "como dar continuidade",
  "mensagens de follow", "não respondeu o que faço", "como reativar prospect", ou /venda-follow-up.
---

# /venda-follow-up — Sequência de 5 mensagens pós-abordagem
...
- FUP 3: Oferecer diagnóstico grátis como reativação — chama `/venda-diagnostico` se ainda não foi feito
...
> "Quer que eu abra o banco de objeções com o contorno pra essa situação? (chamo `/venda-objecoes`)"
