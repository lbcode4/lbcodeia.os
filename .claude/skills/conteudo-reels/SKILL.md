...
description: >
  ...
  "vídeo pro instagram", "roteiro pra gravar", ou /conteudo-reels.
---

# /conteudo-reels — Roteiro completo para Reels
...
Sempre oferecer:
> "Quer adicionar esse reel ao calendário de conteúdo? (chamo `/conteudo-calendario`)"
> "Quer criar uma sequência de stories complementar? (chamo `/conteudo-stories`)"
