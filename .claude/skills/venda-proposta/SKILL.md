...
description: >
  ...
  Puxa dados do dossiê (/venda-dossie), calcula ROI estimado, gera HTML de 2 páginas
  ...
  "proposta pra [prospect]", ou /venda-proposta.
---

# /venda-proposta — Proposta comercial visual pra empresa
...
Sempre oferecer:
> "Quer gerar a sequência de follow-up pra acompanhar essa proposta? (chamo `/venda-follow-up`)"
...
- **Sempre oferecer `/venda-follow-up`** após gerar proposta
