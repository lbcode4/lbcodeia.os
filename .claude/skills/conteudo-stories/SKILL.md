...
description: >
  ...
  "conteúdo pra stories", "fazer stories", ou /conteudo-stories.
---

# /conteudo-stories — Sequência de 5-7 stories interativos
...
Sempre oferecer:
> "Quer incluir essa sequência no calendário de conteúdo? (chamo `/conteudo-calendario`)"
