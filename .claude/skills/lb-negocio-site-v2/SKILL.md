...
description: >
  ...
  ui-ux-pro-max). Use quando o usuário pedir "site com ui-ux-pro-max", "site v2",
  "outra versão do site", "comparar motor de design", "segunda opção de site/LP",
  ou /lb-negocio-site-v2 — para comparar resultado visual com /lb-negocio-site.
---
