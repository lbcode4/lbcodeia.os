...
description: >
  ...
  "prioridades do mês", "plano mensal", ou /negocio-plano-mensal.
---

# /negocio-plano-mensal — Plano executivo do mês
...
**Skills:** `/venda-diagnostico` `/venda-prospectar` `/venda-dossie` `/venda-proposta` `/venda-objecoes` `/venda-follow-up`

| Semana | Ação concreta | Skill | Status |
|--------|---------------|-------|--------|
| Sem 1 | Levantar 20 prospects + fazer 5 diagnósticos | `/venda-diagnostico` | ⬜ |
| Sem 1 | Enviar diagnósticos + abordagem personalizada | `/venda-prospectar` | ⬜ |
| Sem 2 | Follow-up dos que não responderam | `/venda-follow-up` | ⬜ |
| Sem 2 | Dossiê dos interessados + proposta | `/venda-dossie` + `/venda-proposta` | ⬜ |
| Sem 3 | Objeções e negociação | `/venda-objecoes` | ⬜ |
| Sem 4 | Reativação + novo lote de prospects | `/venda-follow-up` | ⬜ |
...
**Skills:** `/conteudo-calendario` `/conteudo-carrossel` `/conteudo-reels` `/conteudo-stories`

| Semana | Ação | Skill | Status |
|--------|------|-------|--------|
| Sem 1 | Montar calendário do mês inteiro | `/conteudo-calendario` | ⬜ |
| Sem 1-4 | Criar e publicar 5 posts/semana conforme calendário | `/conteudo-carrossel` `/conteudo-reels` | ⬜ |
| Sem 2 | Sequência de stories pra gerar leads | `/conteudo-stories` | ⬜ |
...
**Skills:** `/meta-campanha-whatsapp` `/google-ads` `/meta-relatorio`
**Pré-requisito:** verificar bloqueadores técnicos antes de ativar

| Semana | Ação | Skill | Status |
|--------|------|-------|--------|
| Sem 1 | Verificar pré-requisitos (Pixel, LP, perfil) | — | ⬜ |
| Sem 2 | Criar estrutura da campanha | `/meta-campanha-whatsapp` | ⬜ |
| Sem 3 | Subir campanha + monitorar 7 dias | — | ⬜ |
| Sem 4 | Relatório e ajustes | `/meta-relatorio` | ⬜ |
...
> "Quer gerar o calendário de conteúdo já? (chamo `/conteudo-calendario`)"
