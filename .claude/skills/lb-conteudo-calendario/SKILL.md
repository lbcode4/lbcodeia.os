...
description: >
  ...
  "programar conteúdo", "quantos posts essa semana", "plano de conteúdo", ou /lb-conteudo-calendario.
---

# /lb-conteudo-calendario — Calendário editorial mensal
...
|------|-----|-------|---------------|---------|-------|--------|
| [dd/mm] | Seg | E | "3 motivos pra agenda ter espaço às 14h" | Carrossel | `/lb-conteudo-carrossel` | ⬜ |
| [dd/mm] | Ter | R | "Empresa X saiu de 65% pra 90% de ocupação" | Reel | `/lb-conteudo-reels` | ⬜ |
| [dd/mm] | Qua | N | "Novo: agente responde enquanto você atende" | Reel | `/lb-conteudo-reels` | ⬜ |
| [dd/mm] | Qui | I | "O que separa empresa cheia de empresa vazia" | Carrossel | `/lb-conteudo-carrossel` | ⬜ |
| [dd/mm] | Sex | A | "Bastidores — como é o onboarding de uma empresa" | Stories | `/lb-conteudo-stories` | ⬜ |
...
Sempre oferecer:
> "Quer que eu já crie o primeiro carrossel do calendário? (chamo `/lb-conteudo-carrossel`)"
> "Quer criar os roteiros de Reels planejados? (chamo `/lb-conteudo-reels`)"
