...
description: >
  ...
  "ganhar seguidores qualificados", "turbinar post pra seguidores", ou /lb-meta-campanha-seguidores.
---

# /lb-meta-campanha-seguidores — Campanha #1: Seguidores Qualificados
...
- **Outputs:** `saidas/marketing/campanhas/engajamento/meta-seguidores-<YYYY-MM-DD>/`

---

## Pré-requisitos

1. Perfil Instagram auditado (score ≥5/7 em `/lb-conteudo-auditoria-insta`)
...
```
saidas/marketing/campanhas/engajamento/meta-seguidores-<YYYY-MM-DD>/
