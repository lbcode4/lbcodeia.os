...
description: >
  ...
  "pesquisa esse negócio", "dossiê", ou /venda-dossie.
---

# /venda-dossie — Dossiê pra abordagem de prospect
...
- **Instagram (7 elementos):** Score X/7 (rodar `/conteudo-auditoria-insta` se for fundo)
...
Sempre oferecer:
- *"Quer gerar abordagem personalizada com esse dossiê? (chamo `/venda-prospectar`)"*
...
- **Não fazer 100 dossiês de uma vez** — qualidade > quantidade. Pra volume usar `/venda-prospectar` (que orquestra)
