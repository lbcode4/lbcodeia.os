...
**Dica v1:** o resumo do Mapa de Referência entra como input da skill `frontend-design` no Passo 3 — passar estrutura de seções + lógica de paleta detectada junto com a identidade da marca.
