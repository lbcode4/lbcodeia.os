...
description: >
  ...
  "gerar conversas WhatsApp", "campanha meta whatsapp", ou /meta-campanha-whatsapp.
---

# /meta-campanha-whatsapp — Campanha #2: Vendas 1-a-1 WhatsApp
...
- **Auditoria perfil IG (recomendado):** rodar `/conteudo-auditoria-insta` antes — sem perfil organizado, custo sobe
...
4. Perfil IG mínimo organizado (auditoria via `/conteudo-auditoria-insta`)
...
marketing/campanhas/meta-whatsapp-<YYYY-MM-DD>/
  ...
  criativos/
    ad001-1x1.png       ← imagem feed (chamar /conteudo-carrossel se precisar gerar)
...
## Métricas pra rastrear (entra no `/meta-relatorio`)
