...
description: >
  ...
  "revisar bio", "auditar @", "checar perfil IG", ou /lb-conteudo-auditoria-insta.
---

# /lb-conteudo-auditoria-insta — Auditoria 7 elementos + RETINA
...
Se score <5/7 → recomendar arrumar perfil **antes** de rodar `/lb-meta-campanha-seguidores`.

Se score 5-7 → liberado pra rodar campanha de seguidores.

Sempre oferecer:
- *"Quero criar os 5 posts sugeridos agora? (chamo `/lb-conteudo-carrossel` pra cada um)"*
- *"Quero rodar `/lb-meta-campanha-seguidores` com o perfil ajustado?"*
