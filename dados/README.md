...
Solte aqui qualquer arquivo que você quer que o LBCode.IA leia uma vez: CSV
de exportação do Google Ads, planilha de vendas, PDF de contrato,
transcrição de reunião, print de relatório.

Skills como `/lb-negocio-analisar-dados` e `/lb-meta-relatorio` leem direto dessa pasta.
